...
def score_budget_attractiveness(row):
    job_type = row.get("jobType")  # "hourly" or "fixed"
    ...
    return 0.5  # Default neutral if jobType missing
...
def score_avg_hourly_rate(row):
    ...
    if job_type == "fixed":
        return 0.5  # Neutral for fixed-price jobs
...
kpi_columns = [
    "kpi_budget_attractiveness",           # Critical
    "kpi_avg_hourly_rate",                 # High
    # "kpi_contract_to_hire",                # Commented
    # "kpi_enterprise_heuristic",            # Commented
    "kpi_hiring_rate",                     # High
    "kpi_job_engagement",
    "kpi_job_title_relevance",
    "kpi_client_tenure",
...
weights = {
    "kpi_budget_attractiveness": 2.0,         # Critical
    "kpi_avg_hourly_rate": 1.5,              # High
    # "kpi_contract_to_hire": 1.5,             # Commented
    # "kpi_enterprise_heuristic": 2.0,         # Commented
    "kpi_hiring_rate": 1.5,                  # High
}
