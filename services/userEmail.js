...
//   const isTrialMode = process.env.MAILERSEND_TRIAL_MODE === 'true';
//   return isTrialMode ? process.env.MAILERSEND_ADMIN_EMAIL : originalEmail;
// };
...
//   try {
//     const sentFrom = new Sender(process.env.MAILERSEND_FROM_EMAIL, process.env.MAILERSEND_FROM_NAME || "Multi-Tenant System");
    
//     const recipientEmail = getRecipientEmail(email);
//     const recipients = [new Recipient(recipientEmail, username)];
...
//       ? `Your Password Has Been Reset${process.env.MAILERSEND_TRIAL_MODE === 'true' ? ` - For: ${email}` : ''}`
//       : `Password Reset Request${process.env.MAILERSEND_TRIAL_MODE === 'true' ? ` - For: ${email}` : ''}`;
...
//       <body>
//           <div class="container">
//               ${process.env.MAILERSEND_TRIAL_MODE === 'true' ? `
//               <div class="trial-notice">
//                   <strong>TRIAL MODE:</strong> This email was intended for <strong>${email}</strong> but sent to admin due to MailerSend trial limitations.
//               </div>` : ''}
//               <div class="header">
...
//     console.log(`Password email sent successfully to ${recipientEmail} (intended for ${email}):`, response);
//     return response;
//   } catch (error) {
...
//         .setTo(recipients)
//         .setReplyTo(sentFrom)
//         .setSubject(`Invitation to join ${companyName}`)
//         .setHtml(`
//           <!DOCTYPE html>
//           <html>
//           <head>
