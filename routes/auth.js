...
// routes/auth.js (replace handlers with controller wiring)
const express = require('express');
const authController = require('../controllers/authController');

const router = express.Router();

// Login (you already have controllers/authController.login implemented)
router.post('/login', authController.login);

// Company signup with default/custom pipeline
router.post('/company-signup', authController.companySignup);
