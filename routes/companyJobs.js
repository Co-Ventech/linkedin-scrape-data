...
// User-focused listing with pagination + lazy loading
router.get(
  '/user-jobs',
  authenticateToken,
...
// Company stats (for company admin)
router.get(
  '/company-stats',
  authenticateToken,
...
// Stats overview (admin or super_admin)
router.get(
  '/stats/overview',
  authenticateToken,
...
// All companies stats (super_admin)
router.get(
  '/stats/all-companies',
  authenticateToken,
...
// Company users performance (super_admin or same company_admin)
router.get(
  '/:companyId/user-performance',
  authenticateToken,
  requireRole(['super_admin', 'company_admin']),
  getCompanyUserPerformance
);

// List company jobs (company_user or admin)
router.get(
  '/',
  authenticateToken,
