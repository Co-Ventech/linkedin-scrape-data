...
//   try {
//     // Only company_admin or super_admin can access this
//     if (!['company_admin', 'super_admin'].includes(req.user.role)) {
//       return res.status(403).json({ 
//         error: 'Insufficient permissions',
//         required: ['company_admin', 'super_admin'],
...
//     // If company admin, filter by their company only
//     if (companyId) {
...
//       if (duplicateUser) {
//         const field = duplicateUser.username === username ? 'username' : 'email';
//         return res.status(400).json({ 
