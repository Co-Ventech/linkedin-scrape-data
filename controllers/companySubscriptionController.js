...
//     // Check permissions (super admin or company admin can update)
...
//       const plan = await SubscriptionPlan.findOne({ name: subscriptionPlan, isActive: true });
//       if (!plan) {
//         return res.status(400).json({ error: 'Invalid subscription plan' });
//       }

//       updateData.subscriptionPlan = subscriptionPlan;
//       updateData.jobsQuota = plan.jobsQuota; // Update quota based on plan
