...
// // Convert platform-specific job to master job format with ALL enhanced fields
// const convertToMasterJob = (job, platform, batchId) => {
//   const baseJob = {
//     platform,
//     batchId,
...
//       domainExpertise: job.domainExpertise || [],
...
//       codeTestRequired: job.codeTestRequired,
//       backgroundCheckRequired: job.backgroundCheckRequired,
      
//       // Job Source and Tracking
//       sourceUrl: job.sourceUrl,
//       originalPostDate: job.originalPostDate ? new Date(job.originalPostDate) : null,
//       lastUpdatedDate: job.lastUpdatedDate ? new Date(job.lastUpdatedDate) : null,
...
//       bookmarkCount: job.bookmarkCount || 0,
...
//       completenessScore: job.completenessScore,
      
//       // Custom Fields
//       customFields: job.customFields || new Map(),
      
//       // Additional Metadata
//       dataVersion: job.dataVersion || '1.0',
...
//       // Add all NEW ENHANCED FIELDS for Upwork as well
//       contactEmail: job.contactEmail,
//       contactPhone: job.contactPhone,
//       contactName: job.contactName,
//       recruiterName: job.recruiterName,
...
// console.log('Available keys in first job:', Object.keys(jobs[0]));
// // Check specifically for ID fields
// const idFields = ['id', 'jobId', 'linkedinId', 'postId', '_id', 'url'];
// idFields.forEach(field => {
//   if (jobs[0][field]) {
//     console.log(`Found ID field: ${field} = ${jobs[0][field]}`);
//   }
// });
//       const masterJobData = convertToMasterJob(job, platform, batchId);
